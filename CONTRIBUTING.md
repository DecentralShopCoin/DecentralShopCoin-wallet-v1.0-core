Contributing to DecentralShop Core
============================

The DecentralShop Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DecentralShop Core project, and is not to be
confused with overall DecentralShop Network Protocol consensus changes.

Whether a pull request is merged into DecentralShop Core rests with the project merge
...
Patches that change DecentralShop consensus rules are considerably more involved than
...
Where a patch set proposes to change the DecentralShop consensus, it must have been
...
The project leader is the release manager for each DecentralShop Core release.
