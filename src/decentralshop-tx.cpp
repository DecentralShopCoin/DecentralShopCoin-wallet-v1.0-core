...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DecentralShop Core decentralshop-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  decentralshop-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded decentralshop transaction") + "\n" +
                               "  decentralshop-tx [options] -create [commands]   " + _("Create hex-encoded decentralshop transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded decentralshop transaction
