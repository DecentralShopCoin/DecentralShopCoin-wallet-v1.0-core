...
// 8762 = 1*5000 + 1*1000 + 1*500 + 1*100 + 1*50 + 1*10 + 1*5 + 1
static const int ZQ_6666 = 8762;
...
public:
    ...
    void ZDecentralShopBackupWallet();
    ...
    */
    ...
    void setZDecentralShopAutoBackups(bool fEnabled)
    {
