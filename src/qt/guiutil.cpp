...
#define URI_SCHEME "decentralshop"
...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a DecentralShop address (e.g. %1)").arg("PCYiHgGJJ6xGHqivmdZrYjRnhaYf6AJ2Mp"));
#endif
...
{
    // return if URI is not valid or is no DecentralShop: URI
...
{
    // Convert decentralshop:// to decentralshop:
    //
    //    Cannot handle this later, because decentralshop:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open decentralshop.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "DecentralShop.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for DecentralShop.lnk
...
{
    return GetAutostartDir() / "decentralshop.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a decentralshop.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=DecentralShop\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the decentralshop app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add decentralshop app to startup item list
