                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DecentralShop Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DecentralShop address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and decentralshop: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DecentralShop Core"), this);
    aboutAction->setStatusTip(tr("Show information about DecentralShop Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DecentralShop"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DecentralShop addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DecentralShop addresses"));
    ...
    openAction->setStatusTip(tr("Open a DecentralShop: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DecentralShop Core help message to get a list with possible DecentralShop command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DecentralShop Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DecentralShop network", "", count));
}
...
{
    QString strTitle = tr("DecentralShop Core"); // default title
...
/** Creates context menu, its actions, and decentralshops up all the relevant signals for mouse events. */
