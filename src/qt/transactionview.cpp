                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received DecentralShop from zDecentralShop"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDecentralShop"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDecentralShop));
