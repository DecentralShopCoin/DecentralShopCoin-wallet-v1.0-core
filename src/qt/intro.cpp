...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DecentralShop Core"),
     ...
     * override -datadir in the decentralshop.conf file in the default data directory
     * (to be consistent with decentralshopd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
