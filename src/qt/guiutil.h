...
/** Utility functions used by the DecentralShop Qt UI.
 */
namespace GUIUtil
{
...
// Render DecentralShop addresses in monospace font
...
// Parse "decentralshop:" URI into recipient object, return true on successful parsing
