...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DecentralShop server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "DecentralShop server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DecentralShop features */
        {"decentralshop", "masternode", &masternode, true, true, false},
        {"decentralshop", "listmasternodes", &listmasternodes, true, true, false},
        {"decentralshop", "getmasternodecount", &getmasternodecount, true, true, false},
        {"decentralshop", "masternodeconnect", &masternodeconnect, true, true, false},
        {"decentralshop", "masternodecurrent", &masternodecurrent, true, true, false},
        {"decentralshop", "masternodedebug", &masternodedebug, true, true, false},
        {"decentralshop", "startmasternode", &startmasternode, true, true, false},
        {"decentralshop", "createmasternodekey", &createmasternodekey, true, true, false},
        {"decentralshop", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"decentralshop", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"decentralshop", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"decentralshop", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"decentralshop", "getmasternodescores", &getmasternodescores, true, true, false},
        {"decentralshop", "mnbudget", &mnbudget, true, true, false},
        {"decentralshop", "preparebudget", &preparebudget, true, true, false},
        {"decentralshop", "submitbudget", &submitbudget, true, true, false},
        {"decentralshop", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"decentralshop", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"decentralshop", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"decentralshop", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"decentralshop", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"decentralshop", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"decentralshop", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"decentralshop", "checkbudgets", &checkbudgets, true, true, false},
        {"decentralshop", "mnsync", &mnsync, true, true, false},
        {"decentralshop", "spork", &spork, true, true, false},
        {"decentralshop", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"decentralshop", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use decentralshopd, or the -server option to decentralshop-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> decentralshop-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8762/\n";
}
