...
In order to support loading of multiple wallets in decentralshop-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is decentralshop.cpp.
...
Changes to decentralshop.cpp
----------------------
decentralshop.cpp is the entry point into decentralshop-qt, and as such, will require some minor modifications to provide hooks for
